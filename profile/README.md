<div align="center">
  ...
  <p style="font-size: 1.1em; max-width: 600px;">
    <b>Redefining Amateur Racing Telemetry.</b>
    <br>
    <span style="color: #666;">赛车遥测系统 · 开源硬件 · 数据渲染</span>
  </p>
  ...
  <hr style="width: 60%; border-top: 1px solid #eee;">
  
  <sub>
    Designed for track enthusiasts. Open sourced under MIT.
  </sub>
